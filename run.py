    ...
    def create_all(self, data):
        def create_operation():
            for user in data["users"]:
                CRUD.create(db=self.session, model=Users, data=user)
...
if __name__ == '__main__':
    ...
    session_setup = SessionSetup(db_type=db_type, db_name="socialmedia.db")
